//code found: http://monismith.info/cs599/examples/quicksortMPI.c
...
//N = size you want array to be
//X = maximum size of elements
void qs_test(int N)
{
    mpi_quicksort(N);
}
